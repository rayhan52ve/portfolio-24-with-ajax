                        ...
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div
                                    ...
                                    <i data-acorn-icon="luggage" class="text-primary"></i>
                                </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div
                                    class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                    <i data-acorn-icon="laptop" class="text-primary"></i>
                                </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 hover-scale-up cursor-pointer">
                            <div class="card-body d-flex flex-column align-items-center">
                                <div
                                    class="sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center border border-primary mb-4">
                                    <i data-acorn-icon="mobile" class="text-primary"></i>
                                </div>
                ...
                <div class="card" style="overflow:auto">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="DataTbl" class="table table-striped text-center" style="font-size: 11px;">
                                <thead>
                                    <tr>
                                        <th scope="col">SL</th>
                                        <th scope="col">IP</th>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($visitors as $item)
                                        <tr>
                                            <td scope="row">{{ $sl++ }}</td>
                                            <td style="max-width: 70px">{{ $item->ip_address }}</td>
                                            <td style="max-width: 70px">{{ $item->location }}</td>
                                            <td>{{ $item->device }}</td>
                                            <td>{{ $item->browser }}</td>
                                            <td style="max-width: 70px"><a href=" {{ $item->referer }}">
                                                    {{ $item->referer }}</a></td>
                                            <td>{{ $item->home_page }}</td>
                                            <td>{{ $item->about_page }}</td>
                                            <td>{{ $item->project_page }}</td>
                                            <td>{{ $item->contact_page }}</td>
                                            <td style="width: 90px">{{ $item->created_at->toDayDateTimeString() }}</td>
                                            <td style="width: 90px">
                                                <span class="text-{{$item->created_at != $item->updated_at ? 'secondary':'danger'}}">{{$item->updated_at->diffForHumans()}}</span>
                                            </td>
                                        </tr>
